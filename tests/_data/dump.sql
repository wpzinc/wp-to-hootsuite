...
(1, 'siteurl',  'http://127.0.0.1.local', 'yes'),
(2, 'home', 'http://127.0.0.1.local', 'yes'),
(3, 'blogname', 'WP Zinc', 'yes'),
...
(1, 'admin',  '$P$BFWXNjd4ZSQJ5WZbwremiLvJgoQKU4/', 'admin',  'dev-email@flywheel.local', 'http://127.0.0.1', '2022-01-26 12:34:01',  '', 0,  'admin');
