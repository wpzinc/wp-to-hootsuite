...
This document describes the high level workflow used when working on the WordPress Plugin.

You're free to use your preferred IDE and Git client.

## Prerequisites

If you haven't yet set up your local development environment with the Plugin repository installed, refer to the [Setup Guide](SETUP.md).
