...
<div class="wpzinc-option highlight">
	<div class="full">
		<h4><?php esc_html_e( 'Want to post to Instagram, Pinterest or Google My Business?', 'wp-to-hootsuite' ); ?></h4>
		...
		<p>
			...
			echo esc_html(
				...
				/* translators: Plugin Name */
					__( '%s Pro allows you to post to Instagram (Stories and Posts), Pinterest boards and Google My Business, with advanced controls for conditional publishing, tags and scheduling.', 'wp-to-hootsuite' ),
