					...
					<div class="full">
						<h4>
							...
							printf(
								...
								esc_html__( 'Need to connect multiple %s accounts?', 'wp-to-hootsuite' ),
						...
						<p>
							...
							printf(
								/* translators: Service name (Buffer, Hootsuite) */
								esc_html__( '%1$s Pro allows you to connect multiple %2$s accounts to a single WordPress installation.', 'wp-to-hootsuite' ),
