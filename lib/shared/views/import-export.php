...
<header>
	<h1>
		...
		<span>
			<?php esc_html_e( 'Import &amp; Export', 'wp-to-hootsuite' ); ?>
		</span>
	</h1>
</header>
							...
							<div class="postbox wpzinc-vertical-tabbed-ui">
								...
								<ul class="wpzinc-nav-tabs wpzinc-js-tabs" data-panels-container="#import-export-container" data-panel=".panel" data-active="wpzinc-nav-tab-vertical-active">
									<li class="wpzinc-nav-tab download">
										<a href="#import" class="wpzinc-nav-tab-vertical-active">
											<?php esc_html_e( 'Import', 'wp-to-hootsuite' ); ?>
										</a>
									</li>
									<?php
									...
									<li class="wpzinc-nav-tab upload">
										<a href="#export">
											<?php esc_html_e( 'Export', 'wp-to-hootsuite' ); ?>
										</a>
									</li>
								</ul>
								...
								<div id="import-export-container" class="wpzinc-nav-tabs-content">
									...
									<div id="import" class="panel">
										<div class="postbox">
											<header>
												<h3><?php esc_html_e( 'Import', 'wp-to-hootsuite' ); ?></h3>
												<p class="description">
													<?php esc_html_e( 'Upload a file generated by this Plugin\'s export functionality (JSON or zipped JSON).  This will overwrite any existing settings stored on this installation.', 'wp-to-hootsuite' ); ?>
												</p>
											</header>

											<div class="wpzinc-option">
												<div class="left">
													<label for="file"><?php esc_html_e( 'JSON File', 'wp-to-hootsuite' ); ?></label>
												</div>
												<div class="right">
											...
											<div class="wpzinc-option">
												<input name="import" type="submit" class="button button-primary" value="<?php esc_attr_e( 'Import', 'wp-to-hootsuite' ); ?>" />              
											</div>
										</div>
									</div>
									...
									<div id="export" class="panel">
										<div class="postbox">
											<header>
												<h3><?php esc_html_e( 'Export', 'wp-to-hootsuite' ); ?></h3>
												<p class="description">
													<?php esc_html_e( 'To export this Plugin\'s settings, choose which item(s) to export, and click the Export button below.', 'wp-to-hootsuite' ); ?>
													<br />
													<?php esc_html_e( 'You can then import the generated file into another Plugin installation.', 'wp-to-hootsuite' ); ?>
													<br />
													<?php esc_html_e( 'Including this file in a support request? We recommend setting the Format option to "Export as JSON, Zipped".', 'wp-to-hootsuite' ); ?>
												</p>
											</header>
											...
											<div class="wpzinc-option">
												<div class="left">
													<label for="format"><?php esc_html_e( 'Format', 'wp-to-hootsuite' ); ?></label>
												</div>
												<div class="right">
													<select name="format" id="format" size="1">
														<option value="json"><?php esc_html_e( 'JSON', 'wp-to-hootsuite' ); ?></option>
														<option value="zip"><?php esc_html_e( 'JSON, Zipped', 'wp-to-hootsuite' ); ?></option>
													</select>
												</div>
											</div>

											<div class="wpzinc-option">
												<input name="export" type="submit" class="button button-primary" value="<?php esc_attr_e( 'Export', 'wp-to-hootsuite' ); ?>" />              
											</div>
										</div>
									</div>
								</div>
